...
export default function usePortfolioIntro() {
  const [copiedPfIntro, setCopiedPfIntro] =
    useState <
    Pick<PortfolioIntroType, 'title', 'description', 'backgroundImg'>();
  ...
  return { pfIntro: data!, updateIntro: updateIntro.mutate, copiedPfIntro };
}
