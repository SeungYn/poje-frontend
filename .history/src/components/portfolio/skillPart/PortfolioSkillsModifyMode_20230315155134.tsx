...
export default function PortfolioSkillsModifyMode() {
  ...
  return (
    <>
      ...
      {modifySkillList.map((skillSet) => <PortfolioSkillItem key={uuid()} skillType={skillSet.type} skillList={skillSet.skills}  handleSkillIconDelete={handleSkillIconDelete}/>)}
      </PortfolioSkillMasonry>
