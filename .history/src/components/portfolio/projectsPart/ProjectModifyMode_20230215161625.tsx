...
export default function ProjectModifyMode({
  ...
  const { copiedProject } = useProjectModify(item);
  ...
  return (
    <>
      <ProjectWrapper as='form'>
        ...
        <DescriptionWrapper>
          <ProjectHeaderWrapper>
            <ProjectTitle name='name' value={prInfo.name} />
            <ProjectSubTitle name='belong' value={prInfo.belong} />
          </ProjectHeaderWrapper>
          <ExplainSectionWrapper>
          ...
          <SubExplainWrapper>
            ...
            <ValueInput name='duration' value={prInfo.duration} />
            <Property>깃허브 링크</Property>
            <ValueInput name='link' value={prInfo.link} />
            <Property>수상 기관</Property>
            <ValueInput name='supervision' value={prAwardInfo.supervision} />
            <Property>수상 순위</Property>
            <ValueInput name='grade' value={prAwardInfo.grade} />
