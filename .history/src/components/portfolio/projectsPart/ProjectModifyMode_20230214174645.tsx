    ...
    <ProjectWrapper>
      ...
      <DescriptionWrapper>
        ...
        <SubExplainWrapper>
          ...
          <Value as='input' value={prInfo.duration} />
          <Property>깃허브 링크</Property>
          <Value as='input' value={prInfo.link} />
          <Property>수상 기관</Property>
          <Value as='input' value={prAwardInfo.supervision} />
          <Property>수상 순위</Property>
          <Value as='input' value={prAwardInfo.grade} />
          <Property>수상 소감</Property>
          <Value as='input' value={prAwardInfo.description} />
