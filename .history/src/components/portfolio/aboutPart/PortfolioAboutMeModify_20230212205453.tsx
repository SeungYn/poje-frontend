    ...
    <FormContainer>
      <InfoList>
        <InfoItem>
          ...
          <InfoText>
            <p>이름</p>
            <InputText name='nickName' value={form.nickName} />
          </InfoText>
        </InfoItem>
        <InfoItem>
          ...
          <InfoText>
            <p>이메일</p>
            <InputText name='email' onChange={} value={form.email} />
          </InfoText>
        </InfoItem>
        <InfoItem>
          <BsFillPersonFill className='font' />
          <InfoText>
            <p>연락처</p>
            <InputText name='phoneNum' value={form.phoneNum} />
          </InfoText>
        </InfoItem>
        <InfoItem>
          ...
          <InfoText>
            <p>생년월일</p>
            <InputText name='birth' value={form.birth} />
          </InfoText>
        </InfoItem>
        <InfoItem>
          ...
          <InfoText>
            <p>학력</p>
            <InputText name='academic' value={form.academic} />
          </InfoText>
        </InfoItem>
        ...
        <InfoItem>
          ...
          <InfoText>
            <p>학과</p>
            <InputText name='dept' value={form.dept} />
          </InfoText>
        </InfoItem>
      </InfoList>
    </FormContainer>
