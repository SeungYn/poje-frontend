...
interface PortfolioMakeFormtype {
  title: string;
  cssProps: CSSProp;
}

export default function PortfolioMakeForm({}: PortfolioMakeFormtype) {
  const styledTheme = useTheme();
  const nav = useNavigate();
  return (
    <MakeForm>
      <BeforeButton color={styledTheme.mainColorDark} onClick={() => nav(-1)} />
