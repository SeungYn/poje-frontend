...
export default function MemberModify() {
  ...
  return (
    <Container>
      ...
      <ItemName>
        <label>이름</label>
        <CommonInput value={form.nickName} />
      </ItemName>
      <ItemAcad>
        <label>학력</label>
        <CommonInput value={form.academic} />
      </ItemAcad>
      <ItemDept>
        <label>학과</label>
        <CommonInput value={form.dept} />
      </ItemDept>
      <ItemBrith>
        <label>생일</label>
        <CommonInput value={form.birth} />
      </ItemBrith>
      <ItemPhone>
        <label>전화번호</label>
        <CommonInput value={form.phoneNum} />
      </ItemPhone>
      <ItemEmail>
        <label>이메일</label>
        <CommonInput value={form.email} />
      </ItemEmail>
      <ItemGit>
        <label>깃허브 링크</label>
        <CommonInput value={form.gitHubLink} />
      </ItemGit>
      <ItemBlog>
        <label>블로그 링크</label>
        <CommonInput value={form.blogLink} />
      </ItemBlog>
