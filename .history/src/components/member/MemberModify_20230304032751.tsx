...
export default function MemberModify() {
  ...
  return (
    <Container>
      ...
      <ItemAcad>
        <label>학력</label>
        <CommonInput name='nickName' value={form.academic} />
      </ItemAcad>
      <ItemDept>
        <label>학과</label>
        <CommonInput name='nickName' value={form.dept} />
      </ItemDept>
      <ItemBrith>
        <label>생일</label>
        <CommonInput name='nickName' value={form.birth} />
      </ItemBrith>
      <ItemPhone>
        <label>전화번호</label>
        <CommonInput name='nickName' value={form.phoneNum} />
      </ItemPhone>
      <ItemEmail>
        <label>이메일</label>
        <CommonInput name='nickName' value={form.email} />
      </ItemEmail>
      <ItemGit>
        <label>깃허브 링크</label>
        <CommonInput name='nickName' value={form.gitHubLink} />
      </ItemGit>
      <ItemBlog>
        <label>블로그 링크</label>
        <CommonInput name='nickName' value={form.blogLink} />
      </ItemBlog>
