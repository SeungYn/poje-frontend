...
export default function PasswordModifyPage() {
  ...
  const [state, dispatch, onSubmit] = usePwModifyForm();

  return (
    <PwModifyPageContainer onSubmit={onSubmit}>
      ...
      <Item>
        ...
        <MiniWarning>{state.error}</MiniWarning>
        <CommonInput
          name='newPasswordConfirm'
          value={state.newPasswordConfirm}
          onChange={(e) =>
            dispatch({ type: 'newPasswordConfirm', payload: e.target.value })
          }
        />
      </Item>
